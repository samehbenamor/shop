            ...
            switch (_c.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, manager.transaction(function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            var _a, seededStore, regions, products, _b, categories, shipping_options, users, _c, publishable_api_keys, gcProfile, defaultProfile, store, users_1, users_1_1, u, pass, e_1_1, regionIds, regions_1, regions_1_1, r, dummyId, reg, e_2_1, shipping_options_1, shipping_options_1_1, so, e_3_1, createProductCategory, categories_1, categories_1_1, c, e_4_1, _loop_1, products_1, products_1_1, p, e_5_1, defaultSalesChannel, e_6, publishable_api_keys_1, publishable_api_keys_1_1, pak, publishableApiKey, e_7_1;
                            var e_1, _d, e_2, _e, e_3, _f, e_4, _g, e_5, _h, e_7, _j;
                            var _this = this;
                            return __generator(this, function (_k) {
                                switch (_k.label) {
                                    case 0:
                                        _a = JSON.parse(fs_1.default.readFileSync(resolvedPath, "utf-8")), seededStore = _a.store, regions = _a.regions, products = _a.products, _b = _a.categories, categories = _b === void 0 ? [] : _b, shipping_options = _a.shipping_options, users = _a.users, _c = _a.publishable_api_keys, publishable_api_keys = _c === void 0 ? [] : _c;
                                        return [4 /*yield*/, shippingProfileService.retrieveGiftCardDefault()];
                                    case 1:
                                        gcProfile = _k.sent();
                                        return [4 /*yield*/, shippingProfileService.retrieveDefault()];
                                    case 2:
                                        defaultProfile = _k.sent();
                                    ...
                                    case 27:
                                        try {
                                            if (shipping_options_1_1 && !shipping_options_1_1.done && (_f = shipping_options_1.return)) _f.call(shipping_options_1);
                                        }
                                    ...
                                    case 28:
                                        createProductCategory = function (parameters, parentCategoryId) {
                                            ...
                                            return __awaiter(_this, void 0, void 0, function () {
                                                var categoryChildren, category, categoryChildren_1, categoryChildren_1_1, categoryChild, e_8_1;
                                                var e_8, _a;
                                    ...
                                    case 35:
                                        try {
                                            if (categories_1_1 && !categories_1_1.done && (_g = categories_1.return)) _g.call(categories_1);
                                        }
                                        finally { if (e_4) throw e_4.error; }
                                        return [7 /*endfinally*/];
                                    case 36:
                                        _loop_1 = function (p) {
                                            var variants, newProd, optionIds_1, variants_1, variants_1_1, v, variant, e_9_1;
                                            var e_9, _l;
                                            return __generator(this, function (_m) {
                                                switch (_m.label) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        variants_1 = (e_9 = void 0, __values(variants)), variants_1_1 = variants_1.next();
                                                        _m.label = 3;
                                                    case 3:
                                                    ...
                                                    case 8:
                                                        try {
                                                            if (variants_1_1 && !variants_1_1.done && (_l = variants_1.return)) _l.call(variants_1);
                                                        }
                                    ...
                                    case 43:
                                        try {
                                            if (products_1_1 && !products_1_1.done && (_h = products_1.return)) _h.call(products_1);
                                        }
                                    ...
                                    case 55:
                                        try {
                                            if (publishable_api_keys_1_1 && !publishable_api_keys_1_1.done && (_j = publishable_api_keys_1.return)) _j.call(publishable_api_keys_1);
                                        }
