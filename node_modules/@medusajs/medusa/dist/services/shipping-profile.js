...
var ShippingProfileService = /** @class */ (function (_super) {
    ...
    function ShippingProfileService(_a) {
        var shippingProfileRepository = _a.shippingProfileRepository, productService = _a.productService, productRepository = _a.productRepository, shippingOptionService = _a.shippingOptionService, customShippingOptionService = _a.customShippingOptionService;
        var _this = 
                    ...
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        productServiceTx = this.productService_.withTransaction(manager);
                                        return [4 /*yield*/, productServiceTx.updateShippingProfile((0, utils_1.isString)(productId) ? [productId] : productId, null)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
