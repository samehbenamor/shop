...
declare class ReturnService extends TransactionBaseService {
    ...
    constructor({ totalsService, lineItemService, returnRepository, returnItemRepository, shippingOptionService, returnReasonService, taxProviderService, fulfillmentProviderService, orderService, productVariantInventoryService, }: InjectedDependencies);
    /**
