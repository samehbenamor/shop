...
var CsvParser = /** @class */ (function (_super) {
    ...
    CsvParser.prototype.parse = function (readableStream, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var csvStream, parsedContent, csvStream_1, csvStream_1_1, chunk, e_1_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        csvStream_1 = __asyncValues(csvStream);
                        _b.label = 2;
                    case 2: return [4 /*yield*/, csvStream_1.next()];
                    case 3:
                        if (!(csvStream_1_1 = _b.sent(), !csvStream_1_1.done)) return [3 /*break*/, 5];
                        chunk = csvStream_1_1.value;
                    ...
                    case 7:
                        ...
                        if (!(csvStream_1_1 && !csvStream_1_1.done && (_a = csvStream_1.return))) return [3 /*break*/, 9];
                        return [4 /*yield*/, _a.call(csvStream_1)];
                    case 8:
                        _b.sent();
                        _b.label = 9;
