                ...
                switch (_a.label) {
                    case 0:
                        productIds = lineItems
                            .map(function (l) { var _a; return (_a = l === null || l === void 0 ? void 0 : l.variant) === null || _a === void 0 ? void 0 : _a.product_id; })
                            .filter(function (p) { return p; });
                        return [4 /*yield*/, this.getRegionRatesForProduct(productIds, calculationContext.region)];
                    case 1:
                        productRatesMap = _a.sent();
                        return [4 /*yield*/, Promise.all(lineItems.map(function (l) { return __awaiter(_this, void 0, void 0, function () {
                                var _a, _b;
                                return __generator(this, function (_c) {
                                    ...
                                    if ((_a = l.variant) === null || _a === void 0 ? void 0 : _a.product_id) {
                                        return [2 /*return*/, {
                                                item: l,
                                                rates: (_b = productRatesMap.get(l.variant.product_id)) !== null && _b !== void 0 ? _b : [],
                                            }];
                                    }
                                    /*
