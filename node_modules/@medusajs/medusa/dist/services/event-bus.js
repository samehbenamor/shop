...
var EventBusService = /** @class */ (function (_super) {
    ...
    function EventBusService(_a, config, isSingleton) {
        var stagedJobService = _a.stagedJobService, eventBusModuleService = _a.eventBusModuleService;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        isBulkEmit = !(0, utils_1.isString)(eventNameOrData);
                        events = isBulkEmit
                    ...
                    case 0:
                        ...
                        _loop_1 = function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, this_1.stagedJobService_.list(listConfig)];
                                    case 1:
                                        jobs = _b.sent();
                                        if (!!jobs.length) return [3 /*break*/, 3];
