...
var create_products_1 = require("../../../../workflows/admin/create-products");
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var validated, logger, productService, pricingService, productVariantService, shippingProfileService, featureFlagRouter, productVariantInventoryService, inventoryService, salesChannelService, entityManager, productModuleService, products, product;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!productModuleService) return [3 /*break*/, 3];
                return [4 /*yield*/, (0, create_products_1.createProductsWorkflow)({
                        container: req.scope,
