...
function handleAddOrUpdateLineItem(cartId, data, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var cartService, lineItemService, featureFlagRouter, txCartService, cart, line;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    line = _c.sent();
                    return [4 /*yield*/, txCartService.addLineItem(cart.id, line, {
                ...
                case 4:
                    cart = _c.sent();
                    if (!((_b = cart.payment_sessions) === null || _b === void 0 ? void 0 : _b.length)) return [3 /*break*/, 6];
