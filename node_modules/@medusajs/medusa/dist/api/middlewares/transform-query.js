        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    req.allowedProperties = getAllowedProperties(validated, (_a = req.includes) !== null && _a !== void 0 ? _a : {}, queryConfig);
                    attachListOrRetrieveConfig(req, queryConfig);
                    next();
                    return [3 /*break*/, 3];
                case 2:
                    e_1 = _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    req.validatedQuery = validated;
                    req.filterableFields = getFilterableFields(validated);
                    req.allowedProperties = getStoreAllowedProperties(validated, (_a = req.includes) !== null && _a !== void 0 ? _a : {}, queryConfig);
                    attachListOrRetrieveConfig(req, queryConfig);
                    next();
                    return [3 /*break*/, 3];
                case 2:
 ...
 */
function getStoreAllowedProperties(validated, includesOptions, queryConfig) {
    var _a, _b;
    var allowed = [];
    var includeKeys = Object.keys(includesOptions);
    var fields = validated.fields
        ? (_a = validated.fields) === null || _a === void 0 ? void 0 : _a.split(",")
        : (queryConfig === null || queryConfig === void 0 ? void 0 : queryConfig.allowedFields) || [];
    var expand = validated.expand || includeKeys.length
        ? __spreadArray(__spreadArray([], __read((((_b = validated.expand) === null || _b === void 0 ? void 0 : _b.split(",")) || [])), false), __read(includeKeys), false) : (queryConfig === null || queryConfig === void 0 ? void 0 : queryConfig.allowedRelations) || [];
    allowed.push.apply(allowed, __spreadArray(__spreadArray([], __read(fields), false), __read((0, utils_2.objectToStringPath)((0, utils_2.buildSelects)(expand))), false));
    return allowed;
}
/**
 ...
 * @param includesOptions
 */
function getAllowedProperties(validated, includesOptions, queryConfig) {
    var _a, _b;
    var allowed = [];
    var includeKeys = Object.keys(includesOptions);
    var fields = validated.fields
        ? (_a = validated.fields) === null || _a === void 0 ? void 0 : _a.split(",")
        : (queryConfig === null || queryConfig === void 0 ? void 0 : queryConfig.defaultFields) || [];
    var expand = validated.expand || includeKeys.length
        ? __spreadArray(__spreadArray([], __read((((_b = validated.expand) === null || _b === void 0 ? void 0 : _b.split(",")) || [])), false), __read(includeKeys), false) : (queryConfig === null || queryConfig === void 0 ? void 0 : queryConfig.defaultRelations) || [];
    allowed.push.apply(allowed, __spreadArray(__spreadArray([], __read(fields), false), __read((0, utils_2.objectToStringPath)((0, utils_2.buildSelects)(expand))), false));
    return allowed;
}
