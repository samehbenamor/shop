...
var PriceListImportStrategy = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var batchJob, priceListId, txPriceListService, priceImportOperations;
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        // Delete Existing prices for price list
                                        _a.sent();
                                        return [4 /*yield*/, this.downloadImportOpsFile(batchJobId, types_1.OperationType.PricesCreate)];
                                    case 3:
                                        priceImportOperations = _a.sent();
                                        return [4 /*yield*/, Promise.all(priceImportOperations.map(function (op) { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4 /*yield*/, txPriceListService.addPrices(priceListId, op.prices.map(function (p) {
     ...
     */
    PriceListImportStrategy.prototype.downloadImportOpsFile = function (batchJobId, op) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @param batchJobId - An id of the current batch job being processed.
     */
    PriceListImportStrategy.prototype.deleteOpsFiles = function (batchJobId) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var transactionManager, fileServiceTx, _b, _c, op, e_5, e_6_1;
            var e_6, _d;
