...
var TaxCalculationStrategy = /** @class */ (function () {
    ...
    TaxCalculationStrategy.prototype.calculate = function (items, taxLines, calculationContext) {
        return __awaiter(this, void 0, void 0, function () {
            var lineItemsTaxLines, shippingMethodsTaxLines;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Math.round(this.calculateLineItemsTax(items, lineItemsTaxLines, calculationContext) +
                        this.calculateShippingMethodsTax(calculationContext.shipping_methods, shippingMethodsTaxLines))];
            });
        });
    };
