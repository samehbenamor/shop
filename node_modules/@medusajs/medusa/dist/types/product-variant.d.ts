...
export declare type UpdateProductVariantData = {
    variant: ProductVariant;
    updateData: UpdateProductVariantInput;
};
export declare type UpdateVariantPricesData = {
    variantId: string;
    prices: ProductVariantPrice[];
};
export declare type UpdateVariantRegionPriceData = {
    variantId: string;
    price: {
        currency_code: string;
        region_id: string;
...
export declare type UpdateVariantCurrencyPriceData = {
    variantId: string;
