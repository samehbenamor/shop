...
function InjectTransactionManager(shouldForceTransaction, managerProperty) {
    if (shouldForceTransaction === void 0) { shouldForceTransaction = function () { return false; }; }
    return function (target, propertyKey, descriptor) {
        if (!target.MedusaContextIndex_) {
            throw new Error("To apply @InjectTransactionManager you have to flag a parameter using @MedusaContext");
        }
