...
import { TransactionStepsDefinition, TransactionStepStatus, TransactionState, TransactionHandlerType } from "./types";
export declare type TransactionStepHandler = (actionId: string, handlerType: TransactionHandlerType, payload: TransactionPayload) => Promise<unknown>;
/**
